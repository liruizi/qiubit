...
public class DateUtil {
	...
	/**
	 * 日期格式，年月日，用横杠分开，例如：2006-12-25 00:00:00，2008-08-08 00:00:00
	 */
	public static final String DATE_FORMAT_YYYY_MM_DD_00 = "yyyy-MM-dd 00:00:00";
...
//		c.set(Calendar.MILLISECOND, 999);
	...
	public static void main(String[] args) {
		try {
			...
			Date addDate = addDate(new Date(), 0, 0, -6, 0, 0, 0, 0);
			Date dayEndTime = getDayEndTime(addDate);
			String parseDateStart = parseDateToStr(dayEndTime, DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS);
			String parseDateEnd = parseDateToStr(new Date(), DATE_FORMAT_YYYY_MM_DD_00);
			System.out.println(parseDateStart);
			System.out.println(parseDateEnd);
		} catch (Exception e) {
